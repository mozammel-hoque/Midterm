...
public class UnitTestingStudentProfile {
    public static void main(String[] args) {
        ...
        Student student = new Student("Mozammel", "Hoque", "Platinum", "007");

        try {
            Assert.assertEquals(student.getFirstName(), "Mozammel");
        ...
        try {
            Assert.assertEquals(student.getLastName(), "Hoque");
        ...
        try {
            Assert.assertEquals(student.toString(), "Student(id= 007)Mozammel Hoque  Grade = Platinum");
